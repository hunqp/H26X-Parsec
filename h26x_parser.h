...
extern rtc::binary ReadOneNalu(std::string Link, uint32_t *cursor);
extern rtc::binary ReadOneNalu(uint8_t *data, uint32_t dataLen, uint32_t *cursor);

extern rtc::binary H264ExtrackSPSPPSIDR(std::string Link, uint32_t pos = 0);
extern rtc::binary H264ExtrackSPSPPSIDR(uint8_t *data, uint32_t dataLen, uint32_t pos = 0);
extern rtc::binary H265ExtractVPSSPSPPSIDR(std::string Link, uint32_t pos = 0);
extern rtc::binary H265ExtractVPSSPSPPSIDR(uint8_t *data, uint32_t dataLen, uint32_t pos = 0);

extern void DumpNalu(std::string Link, rtc::binary& buffer);
